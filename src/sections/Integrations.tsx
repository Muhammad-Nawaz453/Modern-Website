...
export default function Integrations() {
    return <section className="py-24 overflow-hidden">
        <div className="container">
            ...
            <p className="text-white/50 mt-4 text-lg">Layers semlessely connects with your favourite tools, making it easy plug into any workflow and collaborate across platform</p>
            </div>
            <div>
